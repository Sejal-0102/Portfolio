...
const Contact = () => {
    ...
    let onsubmit=(data,e)=>{
        e.preventDefault()
        console.log(data);
        axios.post("https://portfolio-b1a81-default-rtdb.asia-southeast1.firebasedatabase.app/",data)
        reset()
    }
            ...
            <div className="container-fluid bg-warning" >
                ...
                <div className="row justify-content-between">
                    <div className="col-md-5">
                        ...
                        <p> (+91) 7057358048</p>
                        <br />
                        <a href="https://github.com/Sejal-0102/Portfolio.git" target="_blank" style={{color:'black'}}><AiFillGithub style={{fontSize:'35px'}} /></a> 
                        <br /><br />
                    </div>
